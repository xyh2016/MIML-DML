function [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Average_Recall,Average_F1,Outputs,Pre_Labels,time]=...
    MIMLSVM_Haus(train_bags,train_target,test_bags,test_target,ratio,svm,cost,A)
...
%     n2 = size(find(train_target(i,:)==-1),2)*0.5;
    n1 = 1; n2=100; % HL=0.03; RL=0.25; AP=0.27; AR=0.32; F1=0.30
%     n1 = 0.01; n2=1;
